...
let AutocompleteBoxComponent = class AutocompleteBoxComponent {
    ...
    suggestTexts() {
        console.log('^(' + this.inputText + '|' + this.inputText.toLowerCase() + '|' + this.inputText.toUpperCase() + ')');
        let pattern = new RegExp('^(' + this.inputText + '|' + this.inputText.toLowerCase() + '|' + this.inputText.toUpperCase() + ')');
        this.filteredItems = new Set();
        if (this.inputText !== '') {
            for (let item of this.items) {
                if (pattern.test(item.id.toString())) {
                    this.filteredItems.add(item.id);
                }
            }
        }
