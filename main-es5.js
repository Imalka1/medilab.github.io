  ...
  function srcAppContentPanelContentPanelComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ContentPanelComponent = /*#__PURE__*/function () {
      ...
      _createClass(ContentPanelComponent, [{
        ...
        key: "toggleNavBarViaHeader",
        value: function toggleNavBarViaHeader(toggle) {
          this.toggle = toggle;
        ...
        key: "toggleNavBarViaSideNav",
        value: function toggleNavBarViaSideNav(toggle) {
          this.width = '0px';
          this.minWidth = '0px';
          this.marginLeft = '0px';
          this.widthContent = 'calc(100%)';
